...
#define FPS_REG_CPR_CTL           (0x05)
    #define FPS_ENABLE_CP             (1 << 7)
    #define FPS_ENABLE_CP_OSC         (1 << 6)
#define FPS_REG_CPR_OVT_TEST_CTL  (0x06)
#define FPS_REG_ANA_I_SET_0       (0x07)
#define FPS_REG_ANA_I_SET_1       (0x08)
#define FPS_REG_SUSP_WAIT_F_CYC_H (0x09)
#define FPS_REG_SUSP_WAIT_F_CYC_L (0x0A)
#define FPS_REG_IMG_CDS_CTL_0     (0x0B)
    #define FPS_MIN_CDS_OFFSET_0      (0x00)
    #define FPS_MAX_CDS_OFFSET_0      (0x7F)
#define FPS_REG_IMG_CDS_CTL_1     (0x0C)
    #define FPS_MIN_CDS_OFFSET_1      (0x0000)
    #define FPS_MAX_CDS_OFFSET_1      (0x01FF)
#define FPS_REG_IMG_PGA0_CTL      (0x0D)
    #define FPS_MIN_PGA_GAIN_0        (0x00)
    #define FPS_MAX_PGA_GAIN_0        (0x0F)
#define FPS_REG_IMG_PGA1_CTL      (0x0E)
    #define FPS_MIN_PGA_GAIN_1        (0x00)
    #define FPS_MAX_PGA_GAIN_1        (0x0F)
#define FPS_REG_IMG_ROW_BEGIN     (0x0F)
#define FPS_REG_IMG_ROW_END       (0x10)
#define FPS_REG_IMG_COL_BEGIN     (0x11)
#define FPS_REG_IMG_COL_END       (0x12)
#define FPS_REG_DET_CDS_CTL_0     (0x13)
#define FPS_REG_DET_CDS_CTL_1     (0x14)
#define FPS_REG_DET_PGA0_CTL      (0x15)
#define FPS_REG_DET_PGA1_CTL      (0x16)
#define FPS_REG_DET_ROW_BEGIN     (0x17)
#define FPS_REG_DET_ROW_END       (0x18)
#define FPS_REG_DET_COL_BEGIN     (0x19)
#define FPS_REG_DET_COL_END       (0x1A)
#define FPS_REG_V_DET_SEL         (0x1B)
    #define FPS_MAX_DETECT_TH         (0x3F)
    #define FPS_MIN_DETECT_TH         (0x00)
#define FPS_REG_TEST_ANA          (0x1C)
...
#define FPS_REG_SET_ANA_0         (0x1D)
#define FPS_REG_SET_ANA_1         (0x1E)
#define FPS_REG_SET_ANA_2         (0x1F)

// Alias for future products
#define FPS_REG_CPR_CTL_0         FPS_REG_CPR_CTL
#define FPS_REG_OVT_TEST_CTL      FPS_REG_CPR_OVT_TEST_CTL   
